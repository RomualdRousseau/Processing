...
/*
  ...
  arm[0] = new Bone(shoulder[0], DOFY, new float[] {0, -QUARTER_PI, 3 * QUARTER_PI / 2}, 100);
  forearm[0] = new Bone(arm[0], DOFZ, new float[] {0, -QUARTER_PI, 0}, 50);
  claw[0] = new Bone(forearm[0], DOFZ, new float[] {0, -QUARTER_PI, 0}, 200);

  shoulder[1] = new Bone(back1, DOF0, new float[]{0, QUARTER_PI, PI}, 100);
  arm[1] = new Bone(shoulder[1], DOFY, new float[]{0, QUARTER_PI, PI - 3 * QUARTER_PI / 2}, 100);
  forearm[1] = new Bone(arm[1], DOFZ, new float[]{0, QUARTER_PI, PI}, 50);
  claw[1] = new Bone(forearm[1], DOFZ, new float[]{0, QUARTER_PI, PI}, 200);
  
  shoulder[2] = new Bone(back2, DOF0, new float[] {0, QUARTER_PI, 0}, 100);
  arm[2] = new Bone(shoulder[2], DOFY, new float[] {0, QUARTER_PI, 3 * QUARTER_PI / 2}, 100);
  forearm[2] = new Bone(arm[2], DOFZ, new float[] {0, QUARTER_PI, 0}, 50);
  claw[2] = new Bone(forearm[2], DOFZ, new float[] {0, QUARTER_PI, 0}, 200);

  shoulder[3] = new Bone(back2, DOF0, new float[]{0, -QUARTER_PI, PI}, 100);
  arm[3] = new Bone(shoulder[3], DOFY, new float[]{0, -QUARTER_PI, PI - 3 * QUARTER_PI / 2}, 100);
  forearm[3] = new Bone(arm[3], DOFZ, new float[]{0, -QUARTER_PI, PI}, 50);
  claw[3] = new Bone(forearm[3], DOFZ, new float[]{0, -QUARTER_PI, PI}, 200);
*/
  shoulder[0] = new Bone(back1, DOF0, new float[] {0, -QUARTER_PI, 0}, 100);
...
void draw() {  
  ...
  //directionalLight(128, 255, 255, -0.2, -0.2, 0.2);
